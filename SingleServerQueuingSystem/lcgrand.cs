...
namespace SingleServerQueuingSystem
{
    class LCGrand
    {
        public const int MODLUS = 2147483647;
        public const int MULT1 = 24112;
        public const int MULT2 = 26143;


        /* Set the default seeds for all 100 streams. */

        static long[] zrng = new long[]
        {         1,
        ...
        public static float lcgrand(int stream)
        {
            long zi, lowprd, hi31;
